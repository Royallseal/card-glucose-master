...
2. **两阶段商店定价标杆**：
   * **第一个商店（第 5 关）**：击败 4 名普通敌人后到达。玩家的预期金币应能购买 **1张优秀卡**，或者 **1张普通卡 + 1张良好卡** 的组合。
   * **第二个商店（第 11 关）**：假设第一阶段的金币已在商店 1 全部花光，玩家在此阶段击败了 1 个 Boss 和 4 个普通敌人。到达商店 2 时积累的金币，应同样能够支撑购买 **1张优秀卡**，或者 **1张普通卡 + 1张良好卡**。
...
这一数学关联极为契合，因此 **Boss 金币掉落基准值** 被设定为约 **100** 金币。
...
| | 优秀卡牌 (Rare) | **220** | $220 \pm 20$ ($200 \sim 240$) | 约 100% |
...
* 购买 **1张优秀卡** 期望花费：$\mathbf{220}$ 金币。
* 购买 **1张普通卡 + 1张良好卡** 期望花费：$90 + 130 = \mathbf{220}$ 金币。

通过微小波动的叠加，可以制造出以下几种极为有趣的对局边界状态：

### 案例 A：非酋状态（金币刚好差一点点）
* **玩家金币掉落偏低**：击败 4 名普通敌人，分别掉落 $26, 27, 26, 28$ 金币，总共获得 $107$ 金币。加上初始 $99$，共 **206** 金币。
* **商店卡牌售价偏高**：优秀卡（Rare）定价随机到了 **225** 金币。
* **冲突表现**：此时玩家看到核心优秀卡极其心动，但金币却卡在 $206/225$（**只差 19 金币**！）。此时商店会将该优秀卡**置灰并禁用交互**，迫使玩家不得不买一张普通或良好卡。这种差之厘毫的体验极具Roguelike重玩吸引力。
...
```mermaid
graph TD
    A[进入商店场景] --> B[生成 1普通 + 1良好 + 1优秀商品并计算随机售价]
